<%@ page import="modelo.ProveedorDTO" %>      holallalalalal
...
<html lang="es">
	...
	<body>
		<header class="bg-blue pt-2 pb-1">
			<h4 class="text-center text-light">CRUD Proveedores
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="row" id="formAgregar">
						...
						<div class="col-sm-12">
							<label for="cedula" class="form-label">nit_proveedor</label>
							<input type="tel" class="form-control" name="cedula" required>
						</div>
						<div class="col-sm-12">
							<label for="email" class="form-label">ciudad_proveedor</label>
							<input type="email" class="form-control" name="email" required>
						</div>
						<div class="col-sm-12">
							<label for="nombre" class="form-label">direccion_proveedor</label>
							<input type="text" class="form-control" name="nombre" required>
						</div>
						<div class="col-sm-12">
							<label for="usuario" class="form-label">nombre_proveedor</label>
							<input type="text" class="form-control" name="usuario" required>
						</div>
						<div class="col-sm-12">
							<label for="password" class="form-label">telefono_proveedor</label>
